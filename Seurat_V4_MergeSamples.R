...
opt <- parse_args(OptionParser(usage="Rscript %prog -i input_dir -m /your/path/to/metadata.txt -o output_dir -p 25",
                               description="\nSeurat_V4 to read, filter and merge scRNA-seq data.",
